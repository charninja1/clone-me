...
export default function Badge({
  ...
  const baseStyles = 'inline-flex items-center font-medium rounded-full border transition-all duration-200 hover:scale-105 transform cursor-default';
  ...
  const variantStyles = {
    ...
    accent: 'bg-accent-100 text-accent-800 dark:bg-accent-900/30 dark:text-accent-200 border-accent-200 dark:border-accent-800',
    teal: 'bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-200 border-teal-200 dark:border-teal-800',
    orange: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-200 border-orange-200 dark:border-orange-800',
